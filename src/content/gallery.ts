...
export const GALLERY_REGISTRY: GalleryImage[] = [
  ...
  { key: 'ext13', category: 'Exterior', uuid: '606086fb-f6a7-4ffa-8f80-3c11c817d4a7', label: 'Resort Container Facade & Landscaped Grounds', url: getLocalImageUrl('ext13') },
  { key: 'ext14', category: 'Exterior', uuid: '02540714-812e-4982-9f31-acee9e34ec71', label: 'Container Architecture & Tree Canopy', url: getLocalImageUrl('ext14') },
  { key: 'ext15', category: 'Exterior', uuid: '6f5e4893-6e33-45e4-b423-fa95657e6ccc', label: 'Evening Garden Walkway & Ambient Lights', url: getLocalImageUrl('ext15') },
  ...
  { key: 'pool7', category: 'Pool', uuid: '10bdd539-5da8-4314-912c-439cfa688f22', label: 'Private Swimming Pool Sunlight & Waterfall', url: getLocalImageUrl('pool7') },
  ...
  { key: 'kara4', category: 'Videoke', uuid: 'b676b1d1-08d0-4e3a-a90a-7f1e1b19df75', label: 'Acoustic Videoke Room Music Gallery Wall', url: getLocalImageUrl('kara4') },
  ...
  { key: 'arc4', category: 'Arcade', uuid: '4390364c-4351-4132-9ce7-2bf05973c47b', label: 'Retro Multiplayer Arcade Tournament Station', url: getLocalImageUrl('arc4') },
  
  // 6. Banquet Dining & Signature Wall
  ...
  { key: 'din4', category: 'Dining', uuid: '35e0e064-7569-460f-93e7-3b198feda5d2', label: 'Dining Area & Ambient Warm Evening Lighting', url: getLocalImageUrl('din4') },
  
  // 7. Full Chef\'s Kitchen
  ...
  { key: 'liv2', category: 'Living', uuid: 'f22acb11-9b63-46e9-a12e-bc5075fb53c1', label: 'Spacious Living Area with High Ceilings', url: getLocalImageUrl('liv2') },
  { key: 'liv3', category: 'Living', uuid: '6a7f48ad-6f43-4a93-b7ed-edfe913bc4ca', label: 'Indoor Lounge Seating & Modern Container Interior', url: getLocalImageUrl('liv3') },
  { key: 'liv4', category: 'Living', uuid: '23917df0-e296-4188-a79f-c688a679c56e', label: 'Highland Living Space & Natural Daylight', url: getLocalImageUrl('liv4') },
  ...
  { key: 'bed8', category: 'Bedroom', uuid: 'c7314967-2138-4874-bf9c-036713e1e84f', label: 'Staff & Driver Quarters Bunk Setup', url: getLocalImageUrl('bed8') },
  ...
  { key: 'gym4', category: 'Gym', uuid: 'b991d9df-e76a-4f8f-b354-75f178ecb611', label: 'Gym Dumbbell Rack & Workout Weights', url: getLocalImageUrl('gym4') },
  { key: 'gym5', category: 'Gym', uuid: '1a44844f-9898-4cda-a89e-ed50b2efc598', label: 'Fitness Bench Station & Free Weights', url: getLocalImageUrl('gym5') },
  ...
  { key: 'out8', category: 'Outdoor', uuid: 'eb96db32-3229-4f56-af97-485cb23acdf8', label: 'Outdoor Garden Patio & Container Deck', url: getLocalImageUrl('out8') },
