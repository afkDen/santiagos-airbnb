          ...
          <div className="bg-ink/95 backdrop-blur-2xl border border-gold/40 text-cream p-2.5 sm:p-4 rounded-full sm:rounded-3xl shadow-2xl flex items-center justify-between gap-2.5 sm:gap-4">
            ...
            <div className="flex items-center gap-2 w-full sm:w-auto justify-between sm:justify-end">
              <a
                ...
                className="flex items-center justify-center min-h-[44px] min-w-[44px] sm:min-w-0 px-4 py-2.5 bg-cream/15 hover:bg-cream/25 border border-sand/30 text-cream rounded-full text-xs font-semibold transition-all active:scale-95 shrink-0"
              ...
              <a
                ...
                className="flex-1 sm:flex-initial inline-flex items-center justify-center min-h-[44px] gap-2 px-5 py-2.5 sm:py-3 bg-whatsapp hover:bg-whatsapp-hover text-white font-bold text-xs sm:text-sm rounded-full shadow-warm-md active:scale-95 transition-all group"
              >
